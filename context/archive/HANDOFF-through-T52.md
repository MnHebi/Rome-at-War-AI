# Archived Rome at War AI handoff through T52

> Cold append-only history preserved during the context architecture migration.
> Current operational authority is the root `HANDOFF.md` and
> `context/project-state.json`. Relative paths below are repository-root
