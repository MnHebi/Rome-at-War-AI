# Archived Rome at War AI project rules through T52

> Cold historical record. Current agent authority is the root `AGENTS.md`,
> root `HANDOFF.md`, and `context/project-state.json`. Do not routinely load
> this file; consult it only when provenance for a former rule is required.
